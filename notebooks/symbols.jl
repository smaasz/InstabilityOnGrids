...
begin
	...
	import NaNMath
	using PlutoUI
	import Symbolics: @variables, simplify, expand, get_variables, value, Num, substitute, simplify_fractions
...
@variables f₀ g N² Ri M² β θU 𝕂ᵘ 𝕂ᵇ H Nz k l a h z
...
fsymbols = !isdownload ? Missing :
	let
	RuntimeGeneratedFunctions.init(@__MODULE__)
	config = @dict(grid_t, hmt_scheme, hst_scheme=:low, dissip_scheme=:biharmonic)
...
# ╔═╡ da48b522-b593-4bc4-b86d-aaa4c430ac15
colordf = let
...
# ╔═╡ 3dc9655b-cf5e-4dcb-ab46-bd6a645c3fab
begin
...
a: $(@bind sa PlutoUI.Slider([6.25e3, 12.5e3, 25e3]; default=6.25e3, show_value=true))

Ri: $(@bind sRi Select([100.0, 0.5]; default=100//1))

hmt-scheme: $(@bind shmt_scheme Select(hmt_schemes[grid_t]))
...
# ╔═╡ ea1fee5d-0a04-49af-ba3c-f423a15e5bef
...
# ╔═╡ 6fb96c80-54b7-44ad-ab76-1625b36e2c8b
plotinstabilities(ddf, sRi; Nz=sNz, θU=sθU, β=sβ, a=sa, Vᵘ=sVᵘ, Vᵇ=sVᵇ, hst_scheme=shst_scheme)
...
manifest_format = "2.0"
project_hash = "919139d4599a957135d2ac1178d878bd0e82f70c"
...
git-tree-sha1 = "4caebb747851c5145982f653b79a463957907a52"
