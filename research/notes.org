...
\begin{enumerate}
\item The vertical advection of mean buoyancy: $\mathrm{N}^2 \mathrm{Av}_z\Hat{w}$,
\item the horizontal advection of mean buoyancy: , and
\item the horizontal advection of mean buoyancy by the background flow:.
\end{enumerate}
...
\end{equation*}
Its linearization around a flow with constant velocities on horizontal
planes is skew-hermitian but not diagonal
...
\left[
\begin{array}{cc}
\frac{ - 3 a \cos\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 3 a \cos\left(  - K a \cos\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 3 a \cos\left( K a \cos\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 3 a \cos\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 4 h \sin\left( \mathtt{{\theta}U} \right) \cos\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - K h \sin\left( \mathtt{{\theta}U} \right) \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \cos\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + K h \sin\left( \mathtt{{\theta}U} \right) \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \cos\left(  - K a \cos\left( \mathtt{{\theta}U} \right) \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \cos\left( K a \cos\left( \mathtt{{\theta}U} \right) \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \cos\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + K h \sin\left( \mathtt{{\theta}U} \right) \right) - 4 h \sin\left( \mathtt{{\theta}U} \right) \cos\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - K h \sin\left( \mathtt{{\theta}U} \right) \right)}{24 h^{2}} + \frac{ - 3 a \sin\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 3 a \sin\left(  - K a \cos\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 3 a \sin\left( K a \cos\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 3 a \sin\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 2 h \sin\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + K h \sin\left( \mathtt{{\theta}U} \right) \right) \sin\left( \mathtt{{\theta}U} \right) - 4 h \sin\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - K h \sin\left( \mathtt{{\theta}U} \right) \right) \sin\left( \mathtt{{\theta}U} \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \sin\left(  - K a \cos\left( \mathtt{{\theta}U} \right) \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \sin\left( K a \cos\left( \mathtt{{\theta}U} \right) \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \sin\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + K h \sin\left( \mathtt{{\theta}U} \right) \right) - 4 h \sin\left( \mathtt{{\theta}U} \right) \sin\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - K h \sin\left( \mathtt{{\theta}U} \right) \right)}{24 h^{2}} \mathit{i} & \frac{3 a \cos\left( K a \cos\left( \mathtt{{\theta}U} \right) - \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 3 a \cos\left(  - K a \cos\left( \mathtt{{\theta}U} \right) - \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 3 a \cos\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 3 a \cos\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 2 h \cos\left( K a \cos\left( \mathtt{{\theta}U} \right) - \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \sin\left( \mathtt{{\theta}U} \right) - 4 h \sin\left( \mathtt{{\theta}U} \right) \cos\left(  - \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) - 2 h \sin\left( \mathtt{{\theta}U} \right) \cos\left(  - K a \cos\left( \mathtt{{\theta}U} \right) - \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \cos\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) + 4 h \sin\left( \mathtt{{\theta}U} \right) \cos\left( \frac{4}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \cos\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right)}{24 h^{2}} + \frac{3 a \sin\left( K a \cos\left( \mathtt{{\theta}U} \right) - \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 3 a \sin\left(  - K a \cos\left( \mathtt{{\theta}U} \right) - \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 3 a \sin\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 3 a \sin\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 2 h \sin\left( K a \cos\left( \mathtt{{\theta}U} \right) - \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \sin\left( \mathtt{{\theta}U} \right) - 2 h \sin\left( \mathtt{{\theta}U} \right) \sin\left(  - K a \cos\left( \mathtt{{\theta}U} \right) - \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \sin\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) + 4 h \sin\left( \mathtt{{\theta}U} \right) \sin\left( \frac{4}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \sin\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) - 4 h \sin\left( \mathtt{{\theta}U} \right) \sin\left(  - \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right)}{24 h^{2}} \mathit{i} \\
\frac{ - 3 a \cos\left(  - K a \cos\left( \mathtt{{\theta}U} \right) + \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 3 a \cos\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 3 a \cos\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 3 a \cos\left( K a \cos\left( \mathtt{{\theta}U} \right) + \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 2 h \cos\left(  - K a \cos\left( \mathtt{{\theta}U} \right) + \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \sin\left( \mathtt{{\theta}U} \right) - 4 h \cos\left(  - \frac{4}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \sin\left( \mathtt{{\theta}U} \right) - 2 h \cos\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \sin\left( \mathtt{{\theta}U} \right) - 2 h \sin\left( \mathtt{{\theta}U} \right) \cos\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \cos\left( K a \cos\left( \mathtt{{\theta}U} \right) + \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) + 4 h \sin\left( \mathtt{{\theta}U} \right) \cos\left( \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right)}{24 h^{2}} + \frac{3 a \sin\left( K a \cos\left( \mathtt{{\theta}U} \right) + \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 3 a \sin\left(  - K a \cos\left( \mathtt{{\theta}U} \right) + \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 3 a \sin\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 3 a \cos\left( \mathtt{{\theta}U} \right) \sin\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) + 4 h \sin\left( \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) \sin\left( \mathtt{{\theta}U} \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \sin\left( K a \cos\left( \mathtt{{\theta}U} \right) + \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) + 2 h \sin\left( \mathtt{{\theta}U} \right) \sin\left(  - K a \cos\left( \mathtt{{\theta}U} \right) + \frac{2}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) - 4 h \sin\left( \mathtt{{\theta}U} \right) \sin\left(  - \frac{4}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) - 2 h \sin\left( \mathtt{{\theta}U} \right) \sin\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right) - 2 h \sin\left( \mathtt{{\theta}U} \right) \sin\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - \frac{1}{3} K h \sin\left( \mathtt{{\theta}U} \right) \right)}{24 h^{2}} \mathit{i} & \frac{3 a \cos\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 3 a \cos\left(  - K a \cos\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 3 a \cos\left( K a \cos\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 3 a \cos\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 2 h \sin\left( \mathtt{{\theta}U} \right) \cos\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - K h \sin\left( \mathtt{{\theta}U} \right) \right) + 4 h \sin\left( \mathtt{{\theta}U} \right) \cos\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + K h \sin\left( \mathtt{{\theta}U} \right) \right) - 2 h \sin\left( \mathtt{{\theta}U} \right) \cos\left(  - K a \cos\left( \mathtt{{\theta}U} \right) \right) - 2 h \sin\left( \mathtt{{\theta}U} \right) \cos\left( K a \cos\left( \mathtt{{\theta}U} \right) \right) + 4 h \sin\left( \mathtt{{\theta}U} \right) \cos\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + K h \sin\left( \mathtt{{\theta}U} \right) \right) - 2 h \sin\left( \mathtt{{\theta}U} \right) \cos\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - K h \sin\left( \mathtt{{\theta}U} \right) \right)}{24 h^{2}} + \frac{ - 3 a \sin\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) - 3 a \sin\left(  - K a \cos\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 3 a \sin\left( K a \cos\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 3 a \sin\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - K h \sin\left( \mathtt{{\theta}U} \right) \right) \cos\left( \mathtt{{\theta}U} \right) + 4 h \sin\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + K h \sin\left( \mathtt{{\theta}U} \right) \right) \sin\left( \mathtt{{\theta}U} \right) - 2 h \sin\left(  - \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - K h \sin\left( \mathtt{{\theta}U} \right) \right) \sin\left( \mathtt{{\theta}U} \right) - 2 h \sin\left( \mathtt{{\theta}U} \right) \sin\left(  - K a \cos\left( \mathtt{{\theta}U} \right) \right) - 2 h \sin\left( \mathtt{{\theta}U} \right) \sin\left( K a \cos\left( \mathtt{{\theta}U} \right) \right) + 4 h \sin\left( \mathtt{{\theta}U} \right) \sin\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) + K h \sin\left( \mathtt{{\theta}U} \right) \right) - 2 h \sin\left( \mathtt{{\theta}U} \right) \sin\left( \frac{1}{2} K a \cos\left( \mathtt{{\theta}U} \right) - K h \sin\left( \mathtt{{\theta}U} \right) \right)}{24 h^{2}} \mathit{i} \\
\end{array}
\right]
\end{equation}
...
$\mathrm{A}={\rm diag(\Top)}$, the column of ones
...
\begin{equation}     
\Sop=-\begin{pmatrix} \mathrm{A} +(M^2/f_0)g_x\cos{\theta}\Wop & -f_0\Dop_1+(M^2/f_0)g_y\cos{\theta}\Wop & gx\Pop & gg_x\mathbf{1}\\
    f_0\Dop_1 +(M^2/f_0)g_x\sin{\theta}\Wop& \mathrm{A} +(M^2/f_0)g_y\sin{\theta}\Wop$ gy\Pop & gg_y\mathbf{1}\\  
    -N^2\Wop g_x +(\mathrm{A}_{xx}B_x+\mathrm{A}_{xy}B_y)\Dop_1 & -N^2\Wop g_y  +(\mathrm{A}_{xy}B_x+\mathrm{A}_{yy}B_y)\Dop_1  & \mathrm{A} & 0\mathbf{1}\\  
